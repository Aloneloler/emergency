...
export default function buildOption(chartOption, registerTheme) {
  ...
  for (let k = 0; k < chartOption.series[0].data.length; k++) {
    dataArray.push(Number(chartOption.series[0].data[k] ));
  }
  ...
  // console.log(max,min,divide,arrNew,"111");
  ...
  //console.log(arrNew,xarrNew,valueArray,dataArray,chartOption,"55555");
     //构建X轴
