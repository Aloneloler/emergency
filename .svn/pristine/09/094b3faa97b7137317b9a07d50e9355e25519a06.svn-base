...
import ShowDetails from './InfoModel/index';
// columns 表头数据
// dataSource 列表数据
// width 宽度
// height 高度
        ...
        {!dataSource.length && (
          <div className={styles.table_placeholder}>
            <div className={styles.empty_normal}>
              <p className={styles.empty_description}>暂无数据</p>
            </div>
          </div>
        )}
      </div>
